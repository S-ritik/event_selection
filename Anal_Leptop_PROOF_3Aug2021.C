...
void Anal_Leptop_PROOF::SlaveBegin(TTree * /*tree*/)
{
  ...
  Tnewvar->Branch("j1_btag_sc_withmatch_genlep",&j1_btag_sc_withmatch_genlep,"j1_btag_sc_withmatch_genlep/F"); 
  Tnewvar->Branch("j2_btag_sc_withmatch_genlep",&j2_btag_sc_withmatch_genlep,"j2_btag_sc_withmatch_genlep/F");
  
  Tnewvar->Branch("j1_btag_sc_withmatch_genb",&j1_btag_sc_withmatch_genb,"j1_btag_sc_withmatch_genb/F"); 
  Tnewvar->Branch("j2_btag_sc_withmatch_genb",&j2_btag_sc_withmatch_genb,"j2_btag_sc_withmatch_genb/F");
  
  Tnewvar->Branch("j1_btag_sc_withmatch_genblep",&j1_btag_sc_withmatch_genblep,"j1_btag_sc_withmatch_genblep/F"); 
  Tnewvar->Branch("j2_btag_sc_withmatch_genblep",&j2_btag_sc_withmatch_genblep,"j2_btag_sc_withmatch_genblep/F");
...
Bool_t Anal_Leptop_PROOF::Process(Long64_t entry)
{
  ...
  for(unsigned ijet=0; ijet<LJets.size(); ijet++){
	...
	if(LJets.size()>0)	j1_btag_sc_ptsort=Jets[0].btag_DeepFlav;
	if(LJets.size()>1)      j2_btag_sc_ptsort=Jets[1].btag_DeepFlav;
      	if (LJets.size()>0) { 
  ...
  for(int it=0;it<2;it++)
      ...
      if(topblep[it][0]>-1 && topblep[it][1] >-1 && topblep[it][2]>-1)
	{
	  if( delta2R(LJets[0].y,LJets[0].phi,genparteta[topblep[it][2]],genpartphi[topblep[it][2]]) < 0.7)
	    j1_btag_sc_withmatch_genlep = Jets[0].btag_DeepFlav;
	  if(delta2R(LJets[1].y,LJets[1].phi,genparteta[topblep[it][2]],genpartphi[topblep[it][2]]) < 0.7)
	    j2_btag_sc_withmatch_genlep = Jets[1].btag_DeepFlav;

	  if(delta2R(LJets[0].y,LJets[0].phi,genparteta[topblep[it][1]],genpartphi[topblep[it][1]]) < 0.8)
	    j1_btag_sc_withmatch_genb = Jets[0].btag_DeepFlav;
	  if(delta2R(LJets[1].y,LJets[1].phi,genparteta[topblep[it][1]],genpartphi[topblep[it][1]]) < 0.8)
	    j2_btag_sc_withmatch_genb = Jets[1].btag_DeepFlav;
	  
	  if(delta2R(LJets[0].y,LJets[0].phi,genparteta[topblep[it][2]],genpartphi[topblep[it][2]]) < 0.7 && delta2R(LJets[0].y,LJets[0].phi,genparteta[topblep[it][1]],genpartphi[topblep[it][2]]) < 0.8)
	    j1_btag_sc_withmatch_genblep = Jets[0].btag_DeepFlav;
	  if(delta2R(LJets[1].y,LJets[1].phi,genparteta[topblep[it][2]],genpartphi[topblep[it][2]]) < 0.7 && delta2R(LJets[1].y,LJets[1].phi,genparteta[topblep[it][2]],genpartphi[topblep[it][2]]) < 0.8)
	    j2_btag_sc_withmatch_genblep = Jets[1].btag_DeepFlav;
	}
    }
  Tnewvar->Fill();
  ...
  if (LJets.size()>1 && lepakmatch <0.8) { 
    ...
    if( delta2R(LJets[1].y,LJets[1].phi, vleptons[1].eta, vleptons[1].phi) <0.7)
      {
