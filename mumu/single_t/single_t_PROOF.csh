...
cd /home/rsaxena/t3store3/CMSSW_10_2_27/src//mumu/single_t/
eval `scramv1 runtime -sh`

cp Summer19UL18_ST_t4f_antitop.log test.log
root runAll.C -l -b -q &> out1.txt
cp test_output.root MuMu_Summer19UL18_ST_t4f_antitop_output.root

cp Summer19UL18_ST_t4f_top.log test.log
root runAll.C -l -b -q &> out2.txt
cp test_output.root MuMu_Summer19UL18_ST_t4f_top_output.root

cp Summer20UL18_ST_s_lep.log test.log
root runAll.C -l -b -q &> out3.txt
cp test_output.root MuMu_Summer20UL18_ST_s_lep_output.root

cp Summer20UL18_ST_tW_antitop.log test.log
root runAll.C -l -b -q &> out4.txt
cp test_output.root MuMu_Summer20UL18_ST_tW_antitop_output.root

cp Summer20UL18_ST_tW_top.log test.log
root runAll.C -l -b -q &> out5.txt
cp test_output.root MuMu_Summer20UL18_ST_tW_top_output.root
