...
cd /home/rsaxena/t3store3/CMSSW_10_2_27/src/mumu/ttbar_non-signal/
eval `scramv1 runtime -sh`

cp Summer20UL18_TTBar_DiLeptonic.log test.log
root runAll.C -l -b -q &> out1.txt
cp test_output.root MuMu_Summer20UL18_TTBar_DiLeptonic_non-signal_output.root

cp Summer20UL18_TTBar_Hadronic.log test.log
root runAll.C -l -b -q  &> out2.txt
cp test_output.root MuMu_Summer20UL18_TTBar_Hadronic_non-signal_output.root

cp Summer20UL18_TTBar_SemiLeptonic.log test.log
root runAll.C -l -b -q  &> out3.txt
cp test_output.root MuMu_Summer20UL18_TTBar_SemiLeptonic_non-signal_output.root
