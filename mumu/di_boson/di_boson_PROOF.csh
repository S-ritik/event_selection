...
cd /home/rsaxena/t3store3/CMSSW_10_2_27/src/mumu/di_boson/
eval `scramv1 runtime -sh`

cp Summer20UL18_WW.log test.log
root runAll.C -l -b -q &> out1.txt
cp test_output.root MuMu_Summer20UL18_WW_output.root

cp Summer20UL18_WZ.log test.log
root runAll.C -l -b -q &> out2.txt
cp test_output.root MuMu_Summer20UL18_WZ_output.root

cp Summer20UL18_ZZ.log test.log
root runAll.C -l -b -q &> out3.txt
cp test_output.root MuMu_Summer20UL18_ZZ_output.root
